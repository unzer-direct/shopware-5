...
Ext.define('Shopware.apps.Order.UnzerDirect.view.detail.ConfirmPanel',
{
    extend: 'Ext.form.Panel',

    alias: 'widget.order-unzerdirect-confirm-panel',

    cls: Ext.baseCSSPrefix + 'order-unzerdirect-confirm-panel',
