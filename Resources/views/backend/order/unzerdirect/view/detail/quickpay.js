...
Ext.define('Shopware.apps.UnzerDirect.view.detail.UnzerDirect',
{
    extend: 'Ext.container.Container',
    
    alias: 'widget.order-unzerdirect-panel',
    cls: Ext.baseCSSPrefix + 'order-unzerdirect-panel',
    
    id: 'order-unzerdirect-panel',
    padding: 10,
    
    snippets: {
        title: '{s name=order/tab/title}UnzerDirect{/s}',
    ...
    initComponent: function() {
        var me = this;
        me.operationStore = Ext.create('Ext.data.Store', { model: 'Shopware.apps.Order.UnzerDirect.model.Operation' });
        ...
        me.unzerdirectPaymentStore.on('paymentUpdate', me.onPaymentUpdate, me); 
    ...
    beforeDestroy: function()
    {
        ...
        me.unzerdirectPaymentStore.un('paymentUpdate', me.onPaymentUpdate, me);
        me.callParent(arguments);
    },
    ...
    {
        var me = this;
        return me.unzerdirectPaymentStore.getById(me.record.get('unzerdirect_payment_id'));
    },
    ...
    {
        var me = this;
        if(id === me.record.get('unzerdirect_payment_id'))
        {
            me.update();
        }
    },
    ...
    {
        var me = this;
        var status = 9;//me.record.raw.unzerdirect.status * 1;
    ...
    {
        var me = this;
        me.fireEvent('reload', me.record.get('unzerdirect_payment_id'));
    },
    createGrid: function()
    {
        var me = this;
        me.grid = Ext.create('Shopware.apps.Order.UnzerDirect.view.list.Operation', {
